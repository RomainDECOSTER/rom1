...
import { UsersListRoutine, UsersCreateRoutine, UserDeleteRoutine, UserViewRoutine, UserUpdateRoutine, UserSortRoutine } from '../../Routines/UsersRoutines';
...
export class UserRedux extends EntityRedux<IUserModel, IPageableIUserModel> {
  constructor() {
    super(UsersListRoutine, UsersCreateRoutine, UserDeleteRoutine, UserViewRoutine, UserUpdateRoutine, UserSortRoutine);
  }
}
