...
import { WorkshopsListRoutine, WorkshopsCreateRoutine, WorkshopDeleteRoutine, WorkshopViewRoutine, WorkshopUpdateRoutine, WorkshopSortRoutine } from '../../Routines/WorkshopsRoutine';
...
export class WorkshopsRedux extends EntityRedux<IWorkshopModel, IPageableWorkshopsModel> {
  constructor() {
    super(WorkshopsListRoutine, WorkshopsCreateRoutine, WorkshopDeleteRoutine, WorkshopViewRoutine, WorkshopUpdateRoutine, WorkshopSortRoutine);
  }
}
